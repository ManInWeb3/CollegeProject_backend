...
# =========== Test that isactive and test dates processed properly ======================
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!
    creat automatically such test

    """


    def test_addtestlog_to_correctPIN_activeTEST_fromtoday(self):
        r = requests.post("http://127.0.0.1/api/v1/testlog/bypin/147483647/", 
        ...
        # ctest = Test.objects.get(pin_code = 1227034489)
        # print("IsActive: " + ctest.isactive())
        self.assertEqual(r.status_code, 200)

    def test_addtestlog_to_correctPIN_activeTEST_tilltoday(self):
        r = requests.post("http://127.0.0.1/api/v1/testlog/bypin/214783647/", 
                files={'screenshot':open('/home/screenshot1495418189067.jpeg', 'rb'), 'photo': open('/home/photo1495270562238.jpeg', 'rb')},
                data={'text': "Example text"})
        self.assertEqual(r.status_code, 200)

    def test_addtestlog_to_correctPIN_inactiveTEST_latedates_notpassed(self):
        r = requests.post("http://127.0.0.1/api/v1/testlog/bypin/135126531/", 
                files={'screenshot':open('/home/screenshot1495418189067.jpeg', 'rb'), 'photo': open('/home/photo1495270562238.jpeg', 'rb')},
                data={'text': "Example text"})
        self.assertEqual(r.status_code, 499)

    def test_addtestlog_to_correctPIN_inactiveTEST_okdatest_passed(self):
        r = requests.post("http://127.0.0.1/api/v1/testlog/bypin/192748647/", 
                files={'screenshot':open('/home/screenshot1495418189067.jpeg', 'rb'), 'photo': open('/home/photo1495270562238.jpeg', 'rb')},
                data={'text': "Example text"})
        self.assertEqual(r.status_code, 499)
...
# # =========== Test that PIN processed properly ======================
    ...
    def test_addtestlog_to_PINnotinDB(self): #404
        r = requests.post("http://127.0.0.1/api/v1/testlog/bypin/6665/", 
                files={'screenshot':open('/home/screenshot1495418189067.jpeg', 'rb'), 'photo': open('/home/photo1495270562238.jpeg', 'rb')},
                data={'text': "Example text"})
    ...
    def test_addtestlog_to_PINcorrectPIN_extra0(self): #404
        r = requests.post("http://127.0.0.1/api/v1/testlog/bypin/11111210/", 
                files={'screenshot':open('/home/screenshot1495418189067.jpeg', 'rb'), 'photo': open('/home/photo1495270562238.jpeg', 'rb')},
                data={'text': "Example text"})
        self.assertEqual(r.status_code, 404)
...
#     #     r = requests.post("http://127.0.0.1/api/v1/testlog/bypin/07ab720%2", 
#     #             files={'screenshot':open('/home/screenshot1495418189067.jpeg', 'rb'), 'photo': open('/home/photo1495270562238.jpeg', 'rb')},
#     #             data={'text': "Example text"})
#     #     self.assertEqual(r.status_code, 404)
